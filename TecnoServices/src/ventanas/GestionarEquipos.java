...
public class GestionarEquipos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(labelFooter, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, -1, -1));

        cmbEstatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Nuevo ingreso", "No reparado", "En revisión", "Reparado", "Entregado" }));
        getContentPane().add(cmbEstatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 40, 130, -1));

        btnMostrar.setBackground(new java.awt.Color(153, 153, 255));
        btnMostrar.setFont(new java.awt.Font("Arial Narrow", 0, 18)); // NOI18N
        ...
        getContentPane().add(btnMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 250, 210, 35));
        getContentPane().add(labelWallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 380));
